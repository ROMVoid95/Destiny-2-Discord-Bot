...
import com.prime.util.destiny.Request;
import com.prime.util.destiny.UserCharID;
import com.prime.util.destiny.Utils;

public class ReqRaids {
	
	static String apiKey = Info.BUNGIE_API_KEY;
	static String domainBase = Request.domain;
