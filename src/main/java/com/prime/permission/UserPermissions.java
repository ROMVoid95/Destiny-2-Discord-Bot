...
public class UserPermissions {
    ...
    public User getDiscordUser() {
        return Prime.getJDA() == null ? null : Prime.getJDA().getUserById(userId);
    }
    ...
    public Guild getDiscordGuild() {
        return Prime.getJDA() == null ? null : Prime.getJDA().getGuildById(guildId);
    }
    ...
    public List<Permission> getEffectivePermissions() {
        PermissionManager manager = Prime.sGetPermissionManager();
    ...
    public Permission getEffectivePermissionEntry(Channel context, String requiredPermissionNode) {
        PermissionManager permissionManager = Prime.sGetPermissionManager();
