...
import static com.prime.util.EmbedUtil.no_permissions;
import static com.prime.util.EmbedUtil.success;
    ...
    protected Message execute(CommandManager.ParsedCommandInvocation invocation, UserPermissions userPermissions) {
        try {
            ...
            if (subCommand.equalsIgnoreCase("list")) {
                ...
                List<Permission> permissionEntries = Prime.sGetPermissionManager().getPermissions(target);
            ...
            if (subCommand.equalsIgnoreCase("allow") || subCommand.equalsIgnoreCase("add")) {
                // Check Permissions
                return Prime.sGetPermissionManager().addPermission(target, Permission.parse(permissionString))
                ...
                if (!Prime.sGetPermissionManager().removePermission(target, Permission.parse(permissionString)))
                    Prime.sGetPermissionManager().addPermission(target, Permission.parse("!" + permissionString));
