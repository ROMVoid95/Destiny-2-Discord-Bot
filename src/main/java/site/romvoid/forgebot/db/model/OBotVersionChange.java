...
package site.romvoid.forgebot.db.model;
...
public class OBotVersionChange {
    ...
    public enum ChangeType {
        ADDED(1, "A", "Added", Emoji.CHECK_MARK_GREEN),
        CHANGED(2, "C", "Changed", Emoji.WRENCH),
        REMOVED(3, "R", "Removed", Emoji.BASKET),
        FIXED(4, "F", "Bugs fixed", Emoji.BUG),
        UNKNOWN(5, "?", "Misc", Emoji.QUESTION_MARK);
