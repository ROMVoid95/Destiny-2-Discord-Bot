...
import site.romvoid.forgebot.guildsettings.DefaultGuildSettings;
import site.romvoid.forgebot.guildsettings.GSetting;
import site.romvoid.forgebot.guildsettings.IGuildSettingType;
...
public class GuildSettings {
    ...
    public boolean canUseMusicCommands(User user, RankSystem userRank) {
        Role requiredRole = getRoleValue(GSetting.MUSIC_ROLE_REQUIREMENT, user.getJDA().getGuildById(guildId));
        if (requiredRole == null || userRank.isAtLeast(RankSystem.GUILD_BOT_ADMIN)) {
            return true;
        }
